-- Migration 005: Add Rating System
-- This migration adds ELO rating tracking, rating history, and global ranking support
...
ADD COLUMN games_until_rated INTEGER DEFAULT 10;
...
CREATE INDEX idx_player_analytics_elo ON player_analytics(elo_rating DESC) WHERE is_rated = TRUE;
